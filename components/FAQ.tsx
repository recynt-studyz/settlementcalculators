    ...
    <section className="w-full max-w-3xl mx-auto">
      ...
      <div className="space-y-3">
        {questions.map((faq, i) => (
          ...
          >
            <summary className="flex cursor-pointer list-none items-center justify-between px-5 py-4 font-medium text-gray-800 dark:text-[#e2e8f0] hover:text-[#1e293b] dark:hover:text-slate-300 transition">
              {faq.q}
