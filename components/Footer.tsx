  ...
  return (
    <footer className="border-t border-gray-100 dark:border-gray-800 py-6 mt-8">
      <p className="text-center text-xs text-gray-400 mb-3 px-4">
        Free settlement calculators for personal injury, car accidents, workers compensation, medical malpractice, wrongful termination, divorce, and debt settlement. Free estimates for all 50 states.
      </p>
      <p className="text-center text-xs text-gray-400 mb-3 px-4 max-w-2xl mx-auto">
        These calculators provide estimates for educational purposes only. Results are not legal advice. Consult a licensed attorney in your state for an accurate case evaluation.
      </p>
      <div className="max-w-3xl mx-auto px-4 flex flex-wrap items-center justify-center gap-x-4 gap-y-1 text-xs text-gray-400">
        <span className="font-mono">settlementcalculators.app</span>
        <span>·</span>
